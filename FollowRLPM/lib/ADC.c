...
#include <lib/ADC.h>
#include <msp430.h>
void adcInitSingle(int clockSelect, int differentialModeSelect, int sampleHoldSelect, int refSelect, int intRefSelecet, int channelSelect, int interruptEnable, int triggerSelect){
...
void adcInitSequence(int clockSelect, int differentialModeSelect, int sampleHoldSelect, int refSelect, int intRefSelecet, int interruptEnable, int triggerSelect, int startChannel, int endChannel){
