 ...
 * P2.1: ADCinit Input, Port Interrupt (Control Signal to start SH circuit, Set High to start)
...
void init(){
    ...
    TA0CTL |= TASSEL_2 |  MC_0; // Select SMCLK as timer clock source, Up mode, TB start.
