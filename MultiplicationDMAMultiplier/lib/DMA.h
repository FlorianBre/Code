 ...
 *
 */
void DMAinit0(unsigned int,  unsigned int *, volatile unsigned int *, unsigned int, unsigned int, unsigned int, unsigned int);
 ...
 *
 */
void DMAinit1(unsigned int,  unsigned int *, volatile unsigned int *, unsigned int, unsigned int, unsigned int, unsigned int);
