...
void timerInitPWMA0(unsigned int periodCycles, unsigned int clockSelect, double dutyCycle, unsigned int pwmOutputMode, unsigned int outputSelect) {
...
void timerInitPWMA1(unsigned int periodCycles, unsigned int clockSelect, double dutyCycle, unsigned int pwmOutputMode, unsigned int outputSelect) {
...
void timerInitPWMB0(unsigned int periodCycles, unsigned int clockSelect, double dutyCycle, unsigned int pwmOutputMode, unsigned int outputSelect) {
