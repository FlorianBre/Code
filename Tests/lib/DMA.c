...
#include <msp430.h>
#include <lib\DMA.h>
void DMAinit0(unsigned int trigSrc, volatile unsigned int *srcAdr, volatile unsigned int *desAdr, unsigned int srcIncr, unsigned int desIncr, unsigned int transferSize ){
    //Source adress
...
void DMAinit2(unsigned int trigSrc, volatile unsigned int *srcAdr, volatile unsigned int *desAdr, unsigned int srcIncr, unsigned int desIncr, unsigned int transferSize ){
